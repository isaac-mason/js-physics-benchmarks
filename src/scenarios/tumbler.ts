...
// ---------------------------------------------------------------------------
// Tumbler — a rotating kinematic open tube that endlessly tumbles a pile of
// boxes. Four kinematic walls rotate about the view axis each frame.
// ---------------------------------------------------------------------------
...
// Four walls of the open square tube, as (localPos, localHalfExtents).
